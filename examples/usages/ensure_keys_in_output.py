...
ensured_data_object = (
    agent.input(
        ...
        "How to develop an independent game? You MUST use the key name 'final.results' instead of the key name 'final.steps' IF value of the key 'control' > 1. Now 'control' is 2."
    )
    .output(
        {
            "control": (int,),
